...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@cubid/comms": path.resolve(__dirname, "packages/comms/src/index.ts"),
      "@cubid/core": path.resolve(__dirname, "packages/core/src/index.ts"),
      "@cubid/cosmos": path.resolve(__dirname, "packages/cosmos/src/index.ts"),
    ...
    projects: [
      {
        test: {
          ...
          include: [
            ...
            "packages/comms/src/**/*.test.ts",
            "packages/cosmos/src/**/*.test.ts",
            ...
            "packages/wallet-recovery/src/**/*.test.ts"
          ],
          name: "node"
        }
      },
