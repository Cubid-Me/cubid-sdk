          ...
          {!cubidAuthenticated ? (
            <>
              ...
              {!passcodeRequested ? (
                ...
                <div className="space-y-4">
                  <p>Check your email for the passcode we just sent</p>
            ...
            <>
              <p className="mb-4 text-yellow-700">
                ...
                <br /><br />
                Twitter Credential available: <strong>{selectedTwitterHandle}</strong>
              </p>
              {showTwitterHandles ? (
                <>
                  ...
                  <Button onClick={handleAuthorize} className="w-full">
                    Authorize {DAPP_NAME} to see this credential
                  </Button>
                </>
              ) : (
                <>
                  <Button onClick={handleAuthorize} className="w-full mb-4">
                    Authorize {DAPP_NAME} to see this credential
                  </Button>
