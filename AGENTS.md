...
- `packages/bitcoin`, `packages/near`, `packages/solana`, `packages/starknet`, and `packages/sui` now carry additional chain-specific wallet layers on top of `@cubid/core`.
