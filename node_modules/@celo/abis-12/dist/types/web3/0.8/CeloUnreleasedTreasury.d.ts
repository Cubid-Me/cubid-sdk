...
export interface CeloUnreleasedTreasury extends Contract {
    clone(): CeloUnreleasedTreasury;
    methods: {
...
export declare function newCeloUnreleasedTreasury(web3: Web3, address: string): CeloUnreleasedTreasury;
