...
(function() {
    ...
    __webpack_require__.m = __webpack_modules__, __webpack_require__.amdO = {}, deferred = [], __webpack_require__.O = function(result, chunkIds, fn, priority) {
        if (!chunkIds) {
            var notFulfilled = 1 / 0;
            for(i = 0; i < deferred.length; i++){
                for(var _deferred_i = _sliced_to_array(deferred[i], 3), chunkIds = _deferred_i[0], fn = _deferred_i[1], priority = _deferred_i[2], fulfilled = !0, j = 0; j < chunkIds.length; j++)(!1 & priority || notFulfilled >= priority) && Object.keys(__webpack_require__.O).every(function(key) {
        ...
        if ("object" == (typeof value === "undefined" ? "undefined" : _type_of(value)) && value) {
        ...
        for(var current = 2 & mode && value; "object" == (typeof current === "undefined" ? "undefined" : _type_of(current)) && !~leafPrototypes.indexOf(current); current = getProto(current))Object.getOwnPropertyNames(current).forEach(function(key) {
        ...
        return (({
            ...
            784: "stories-CubidWidgetCollection-stories",
            820: "stories-CubidWidget-stories"
        })[chunkId] || chunkId) + "." + ({
            122: "bc885a51",
            126: "a0a3556c",
            187: "c3381187",
            ...
            820: "32d36b37",
            949: "a8d92517"
        })[chunkId] + ".iframe.bundle.js";
    }, __webpack_require__.g = function() {
        if ("object" == (typeof globalThis === "undefined" ? "undefined" : _type_of(globalThis))) return globalThis;
        try {
            return this || new Function("return this")();
        } catch (e) {
            if ("object" == (typeof window === "undefined" ? "undefined" : _type_of(window))) return window;
        }
    }(), __webpack_require__.hmd = function(module) {
        return (module = Object.create(module)).children || (module.children = []), Object.defineProperty(module, "exports", {
            enumerable: !0,
            set: function() {
        ...
        if (inProgress[url]) inProgress[url].push(done);
            ...
            if (void 0 !== key) for(var scripts = document.getElementsByTagName("script"), i = 0; i < scripts.length; i++){
                var s = scripts[i];
                if (s.getAttribute("src") == url || s.getAttribute("data-webpack") == "cubid-sdk:" + key) {
                    script = s;
                    break;
                }
            }
            script || (needAttach = !0, (script = document.createElement("script")).charset = "utf-8", script.timeout = 120, __webpack_require__.nc && script.setAttribute("nonce", __webpack_require__.nc), script.setAttribute("data-webpack", "cubid-sdk:" + key), script.src = url), inProgress[url] = [
                done
            ];
        ...
        __webpack_require__.f.j = function(chunkId, promises) {
            ...
            if (0 !== installedChunkData) if (installedChunkData) promises.push(installedChunkData[2]);
                ...
                var promise = new Promise(function(resolve, reject) {
                    return installedChunkData = installedChunks[chunkId] = [
                        resolve,
                        reject
                    ];
                });
        ...
        var webpackJsonpCallback = function(parentChunkLoadingFunction, data) {
            var moduleId, chunkId, _data = _sliced_to_array(data, 3), chunkIds = _data[0], moreModules = _data[1], runtime = _data[2], i = 0;
        ...
        }, chunkLoadingGlobal = self.webpackChunkcubid_sdk = self.webpackChunkcubid_sdk || [];
