...
const Stamps = ({ stampToRender, uuid, page_id, api_key, isGrid, onStampChange, showAllowCreds, email, allStampIds, refresh }) => {
    ...
    const connectToWeb3Node = () => __awaiter(void 0, void 0, void 0, function* () {
        if (address) {
            const { data: { stamps, scores }, } = yield axios_1.default.post("https://passport.cubid.me/api/gitcoin-passport-data", { address });
    ...
    return (react_1.default.createElement("div", { style: {
            ...
            react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("div", { style: {
                    ...
                    react_1.default.createElement("div", { className: "mt-2" }, doesStampExist(exports.stampsWithId.gitcoin) ? (react_1.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } },
                        ...
                        gitcoinModalOpen && (react_1.default.createElement("div", { className: "fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50" },
        ...
        stampToRender === "evm" && (react_1.default.createElement("div", { style: {
                border: "1px solid #ccc",
                width: isGrid ? "100%" : "300px",
                height: "190px",
                borderRadius: "12px",
            ...
            react_1.default.createElement("div", { style: { alignItems: "center" } },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement("h2", { style: { fontWeight: "bold", fontSize: "16px" } }, "EVM Wallet"),
                    react_1.default.createElement("p", { style: { color: "#757575", fontSize: "14px" } }, "Connect to evm wallet"))),
            react_1.default.createElement("div", { style: { marginTop: "8px" } }, doesStampExist(exports.stampsWithId.evm) ? (react_1.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } },
                react_1.default.createElement("button", { style: {
                        borderRadius: "10px",
                        ...
                        padding: "8px 16px",
                        border: "none",
                    } }, "Verified Stamp"))) : (react_1.default.createElement(react_1.default.Fragment, null,
                gitcoinModalOpen && (react_1.default.createElement("div", { style: {
                        position: "fixed",
                        inset: "0",
                    ...
                    react_1.default.createElement("div", { style: {
                        ...
                        connectors.map((connector) => (react_1.default.createElement("button", { key: connector.uid, style: {
                                backgroundColor: "#007bff",
                                color: "white",
                                padding: "8px 16px",
                                borderRadius: "8px",
                                ...
                                marginBottom: "8px",
                                border: "none",
                            }, onClick: () => connect({ connector }) }, connector.name))),
                        react_1.default.createElement("button", { style: {
                                marginTop: "16px",
                                color: "#ff0000",
                                borderRadius: "10px",
                                background: "none",
                                border: "none",
                            }, onClick: () => setGitcoinModalOpen(false) }, "Close")))),
                react_1.default.createElement("button", { style: {
                        backgroundColor: "#007bff",
                        color: "white",
                        padding: "8px 16px",
                        borderRadius: "8px",
                        border: "none",
                    }, onClick: () => setGitcoinModalOpen(true) }, "Connect Evm Wallet")))))),
