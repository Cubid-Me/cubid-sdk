...
export var EmailVerificationModal = function(param) {
    var isOpen = param.isOpen, onClose = param.onClose, onSuccess = param.onSuccess, onError = param.onError, passedEmail = param.email;
    ...
    var handleOtpChange = function(index, value) {
        ...
        setOtp(newOtp);
        if (value && index < 5) {
            var nextInput = document.querySelector('input[name="email-otp-'.concat(index + 1, '"]'));
            if (nextInput) nextInput.focus();
        }
    };
    var handleKeyDown = function(index, e) {
        if (e.key === 'Backspace' && !otp[index] && index > 0) {
            var prevInput = document.querySelector('input[name="email-otp-'.concat(index - 1, '"]'));
    ...
    }, obscureString(passedEmail))), /*#__PURE__*/ React.createElement("div", {
        style: styles.otpContainer
    }, otp.map(function(digit, index) {
        return /*#__PURE__*/ React.createElement("input", {
            key: index,
            type: "text",
            name: "email-otp-".concat(index),
            value: digit,
            onChange: function(e) {
